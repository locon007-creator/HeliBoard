...
object Defaults {
    ...
    const val PREF_THEME_KEY_BORDERS = true // Aurora Next: individually defined, easy-to-target keys
    @JvmField
    ...
    const val PREF_SHOW_NUMBER_ROW = true // Aurora Next: number row on without user setup
